...
public class Alarm {
	 ...
	 */
	public Alarm() {
		waitQueue = new PriorityQueue<Waiter>();
	...
	public static class Waiter implements Comparable {
		...
		public Waiter(long time, KThread thread) {
			wakeTime = time;
			waitThread = thread;
		}
		...
		public int compareTo(Object o) {
			...
			if (wakeTime == waiter.getTime())
				return 0;
			else if (wakeTime < waiter.getTime())
				return -1;
			else return 1;
		}
	}
	
	public static PriorityQueue<Waiter> waitQueue;
}
